    ...
    <div className="container mx-auto text-center">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          digital experience. No store restrictions, direct from developers who
          care about quality.
        </p>

        <Button
          size="lg"
          className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-0 px-12 py-6 text-xl font-bold rounded-2xl shadow-2xl shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 cursor-pointer"
        >
